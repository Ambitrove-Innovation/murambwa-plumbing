  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 px-6 py-4 ${
        isScrolled
          ? "bg-brand-dark/95 backdrop-blur-md shadow-xl py-3"
          : "bg-transparent py-6"
      }`}>
  ...
  return (
    <div className="border-b border-gray-200 py-6">
      <button
        ...
        <div
          className={`p-2 rounded-full transition-all duration-300 ${isOpen ? "bg-brand-gold text-white rotate-180" : "bg-gray-100 text-gray-500"}`}>
          <ChevronDown size={20} />
        </div>
      </button>
      <motion.div
        ...
        <p className="pt-4 text-gray-600 leading-relaxed max-w-3xl">{answer}</p>
      </motion.div>
    </div>
  );
};
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-brand-gold selection:text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pb-24 w-full flex flex-col md:flex-row justify-between items-end gap-12">
          ...
          <motion.div
            ...
            <p className="text-gray-300 text-lg mb-8 leading-relaxed font-light">
              Expert plumbing, maintenance, borehole drilling, and pressure pump
              solutions. Fast response. Quality workmanship.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <motion.div {...fadeIn}>
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8 font-light">
                Admire Murambwa Letlhabile Plumbing provides reliable and
                efficient plumbing services across Lethlabile and surrounding
                areas. We specialize in modern infrastructure maintenance and
            ...
            <motion.div
              ...
              <div className="absolute -bottom-10 -left-10 bg-brand-dark text-white p-10 rounded-[3rem] hidden md:block shadow-2xl border border-white/10">
                <p className="text-5xl font-display font-bold text-brand-gold mb-1">
                  10+
                </p>
                <p className="text-sm uppercase tracking-[0.2em] font-bold opacity-60">
                  Years of Mastery
                </p>
              </div>
            </motion.div>
      ...
      <section
        id="services"
        className="py-32 bg-brand-dark text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div {...fadeIn} className="mb-20 text-center">
            ...
            <p className="text-gray-400 text-xl max-w-2xl mx-auto font-light">
              Comprehensive water and plumbing solutions tailored to your
              specific needs.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                src: "/images/murambwa_inhouse_celling_work.webp",
                title: "Ceiling Work",
              },
              {
                src: "/images/murambwa_modern_bathroom.webp",
                title: "Luxury Bathroom",
              },
              {
                src: "/images/murambwa_outdoor_geyser.webp",
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
              <motion.div {...fadeIn}>
                ...
                <p className="text-xl text-gray-400 mb-12 font-light leading-relaxed">
                  Don't let a plumbing issue disrupt your day. Contact us now
                  for professional, reliable service that lasts.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fadeIn} className="text-center mb-12">
            ...
            <p className="text-gray-600 font-light">
              Visit us in Lethlabile for professional consultations.
            </p>
          </motion.div>
          <motion.div
            {...fadeIn}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-400 font-light leading-relaxed">
                Providing professional, reliable, and efficient plumbing
                solutions across Lethlabile and surrounding areas for over 10
                years.
              </p>
            ...
            {/* Column 2: Services */}
            <div className="space-y-6">
              <h4 className="text-lg font-display font-bold text-brand-gold uppercase tracking-widest">
                Services
              </h4>
                ...
                {[
                  ...
                  <li key={item}>
                    <a
                      ...
                      <ArrowRight
                        size={14}
                        className="text-brand-gold opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all"
                      />
                      {item}
                    </a>
                  </li>
          ...
          <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-gray-500 text-sm font-medium">
              © {new Date().getFullYear()} Letlhabile Plumbing. All rights
              reserved.
            </p>
